...
using RPGMaker.Codebase.Editor.MapEditor.Component.CommandEditor.PostEffect;
using UnityEditor;
using UnityEngine;
...
namespace RPGMaker.Codebase.Editor.MapEditor.Window.EventEdit
{
    public class CommandSettingWindow : BaseWindow
    {
            ...
            )
        {
            ...
            instance.eventEditCanvas = eventEditCanvas;
            instance.PreviewSceneElement = previewSceneElement;
            instance.isBattle = isBattle;
        ...
        private void ShowSettingWindow(int code) {
            ...
            //音楽の再生を行っていた場合止める
            //シーンからオーディオリスナーを取得する
            var audioSource = SoundHelper.GetEditorSceneAudioSource();
            ...
            switch ((EventEnum) code)
            {
                ...
                case EventEnum.MOVEMENT_MOVE_AWAY_FROM_PLAYER:
                    new MoveRoute(_commandSetting, _eventDataModels, instance.eventIndex, instance.eventCommandIndex)
                        .Invoke();
                    break;
                case EventEnum.EVENT_CODE_MOVE_RESPAWN_POINT:
                    new RespawnPoint(_commandSetting, _eventDataModels,
                        instance.eventIndex, instance.eventCommandIndex).Invoke();
                    break;
                ...
                case EventEnum.EVENT_CODE_MAP_GET_POINT:
                    new DesignatedLocationObtain(_commandSetting.Q<VisualElement>(""),
                        ...
                        instance.eventIndex, instance.eventCommandIndex).Invoke();
                    break;
                case EventEnum.EVENT_CODE_MAP_CHANGE_MINIMAP:
                    new MinimapChange(_commandSetting.Q<VisualElement>(""),
                        _eventDataModels,
                        instance.eventIndex, instance.eventCommandIndex).Invoke();
                    break;
                ...
                case EventEnum.EVENT_CODE_SCENE_GOTO_TITLE:
                    new GoBackTitleWindow(_commandSetting.Q<VisualElement>(""),
                        ...
                        instance.eventIndex, instance.eventCommandIndex).Invoke();
                    break;
                case EventEnum.EVENT_CODE_SCENE_CALL_UNITY_SCENE:
                    new CallUnityScene(_commandSetting.Q<VisualElement>(""),
                        _eventDataModels,
                        instance.eventIndex, instance.eventCommandIndex).Invoke();
                    break;
                ...
                case EventEnum.EVENT_CODE_POST_EFFECT_GLITCH:
                    new PostEffectGlitch(
                        _commandSetting.Q<VisualElement>(""),
                        _eventDataModels,
                        instance.eventIndex,
                        instance.eventCommandIndex,
                        instance.eventEditCanvas,
                        instance.PreviewSceneElement,
                        instance.isBattle
                    ).Invoke();
                    break;
                case EventEnum.EVENT_CODE_POST_EFFECT_BLUR:
                    new PostEffectBlur(
                        _commandSetting.Q<VisualElement>(""),
                        _eventDataModels,
                        instance.eventIndex,
                    ...
                    break;
                case EventEnum.EVENT_CODE_POST_EFFECT_BLOOM:
                    new PostEffectBloom(
                        _commandSetting.Q<VisualElement>(""),
                        _eventDataModels,
                        instance.eventIndex,
                    ...
                    break;
                case EventEnum.EVENT_CODE_POST_EFFECT_FILL:
                    new PostEffectFill(
                        _commandSetting.Q<VisualElement>(""),
                        _eventDataModels,
                        instance.eventIndex,
                    ...
                    break;
                case EventEnum.EVENT_CODE_POST_EFFECT_PIXELATE:
                    new PostEffectPixelate(
                        _commandSetting.Q<VisualElement>(""),
                        _eventDataModels,
                        instance.eventIndex,
                        instance.eventCommandIndex,
                    ...
                    break;
                case EventEnum.EVENT_CODE_POST_EFFECT_REMOVE:
                    new PostEffectRemove(
                        _commandSetting.Q<VisualElement>(""),
                        _eventDataModels,
                        instance.eventIndex,
                        instance.eventCommandIndex
        ...
        public class CommandSettingWindowParam : ScriptableSingleton<CommandSettingWindowParam>
        {
            ...
            public EventEditCanvas eventEditCanvas;
            public PreviewSceneElement PreviewSceneElement;
