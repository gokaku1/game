...
namespace RPGMaker.Codebase.CoreSystem.Helper
{
    public static class PathManager
    {
        ...
        public static string GetRPGMakerPersistentFolderPath() {
            // テンポラリのZipファイルを展開するため、共通の.RPGMakerフォルダへのパスを取得する
#if UNITY_EDITOR_WIN
            // 2階層上
            var folderSub = "/../../";
            ...
            var folderSub = "/../../";
#endif
            return Path.Combine(Application.persistentDataPath + folderSub, ".RPGMaker");
        }
    }
}