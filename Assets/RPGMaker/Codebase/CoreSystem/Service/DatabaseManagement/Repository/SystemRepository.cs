...
#else
        public async Task<SystemSettingDataModel> Load() {
#endif
...
#else
            _systemSettingDataModel = (await ScriptableObjectOperator.GetClass<SystemSettingDataModel>(JsonPath)) as SystemSettingDataModel;
#endif
#endif
