...
namespace RPGMaker.Codebase.Editor.MapEditor.Window.EventEdit
{
    ...
    public class EventEditWindow : BaseWindow
    {
        ...
        public EventEditCanvas EventEditCanvas => _eventEditCanvas;
         ...
         */
        private void InitUI() {
            _eventEditCanvas?.UnregisterDetachFromPanelEvent(); //イベントリストウィンドウを閉じてしまわないように。
        ...
        private void SetDefaultLayout() {
            ...
            _eventEditCanvas.style.height = Length.Percent(98);
            _controlPanel.style.width = Length.Percent(100);
            _previewPanel.style.width = Length.Percent(100);
            _controlPanel.style.height = Length.Percent(1);
            _previewPanel.style.height = Length.Percent(0);
        }

        private void SetControlPanelLayout() {
            _eventEditCanvas.style.width = Length.Percent(100);
            _eventEditCanvas.style.height = Length.Percent(90);
            _controlPanel.style.width = Length.Percent(100);
            _previewPanel.style.width = Length.Percent(100);
        ...
        private void SetPreviewLayout() {
            ...
            _controlPanel.style.width = Length.Percent(100);
            _previewPanel.style.width = Length.Percent(100);
            _controlPanel.style.height = Length.Percent(00);
            _previewPanel.style.height = Length.Percent(10);
        }

        /// <summary>
        /// EventEditWindowが抱えているマップのIDを返す。
        /// </summary>
        /// <returns></returns>
        public string GetMapId() {
            return _mapDataModel?.id;
        }
    }
}