...
namespace RPGMaker.Codebase.Editor.Inspector.Map.View
{
    ...
    public class TileGroupInspector : AbstractInspectorElement
    {
        ...
        private Toggle    _autoShadowToggle;
        ...
        override protected void InitializeContents() {
            ...
            _autoShadowToggle = RootContainer.Query<Toggle>("auto_shadow");
        }
        ...
        private void SetEntityToUI() {
            ...
            _autoShadowToggle.value = _tileGroupDataModel.autoShadow;
            _autoShadowToggle.RegisterValueChangedCallback(evt =>
            {
                _tileGroupDataModel.autoShadow = _autoShadowToggle.value;
                mapManagementService.SaveTileGroup(_tileGroupDataModel);
            });
        }
    }
