...
#else
        private async void MoveJump(string currentEventID, EventDataModel.EventCommand command) {
#endif
...
#else
            await jumpData.jump.MoveJumpProcess(currentEventID, command, CloseMovePlace, ProcessEndAction, command.parameters[0]);
#endif
        }
