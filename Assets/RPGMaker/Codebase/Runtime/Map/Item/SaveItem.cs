...
#else
        public async Task Init(RuntimeSaveDataModel runtimeSaveDataModel, int number, SaveMenu.Operation operation) {
#endif
...
#else
            await Refresh(runtimeSaveDataModel);
#endif
            switch (operation)
            {
...
#else
        public async Task Refresh(RuntimeSaveDataModel saveData) {
#endif
