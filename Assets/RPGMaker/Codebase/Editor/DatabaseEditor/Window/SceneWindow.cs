...
namespace RPGMaker.Codebase.Editor.DatabaseEditor.Window
{
    ...
    public class SceneWindow : BaseWindow
    {
        ...
        public PreviewSceneElement PreviewSceneElement => _previewSceneElement;
        ...
        public void Init(object parameter = null) {
            ...
            {
                Vector2Int Size = new Vector2Int((int) evt.newRect.width, (int) evt.newRect.height);
                if (_previewSceneElement.RenderTextureSize == Size)
                {
                    return;
                }
