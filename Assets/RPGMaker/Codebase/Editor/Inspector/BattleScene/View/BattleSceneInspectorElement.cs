...
namespace RPGMaker.Codebase.Editor.Inspector.BattleScene.View
{
 ...
 "Assets/RPGMaker/Codebase/Runtime/Battle/BattleSceneTest/BattleSceneTest.unity";
        ...
        private VisualElement _effectPatternDropdown;
        ...
        protected override void InitializeContents() {
            ...
            _effectPatternDropdown = RootContainer.Query<VisualElement>("effect_pattern_dropdown");
        ...
        private void SetBasicItems() {
            ...
            void AdjustEnemies() {
                ...
                var effectPatternList = new List<string>
                {
                    EditorLocalize.LocalizeText("WORD_6007"),
                    EditorLocalize.LocalizeText("WORD_6008"),
                    EditorLocalize.LocalizeText("WORD_6009"),
                    EditorLocalize.LocalizeText("WORD_6010")
                };
                var encounterEffect = _battleScene.encounterEffect;
                var effectPatternDropdownPopupField = new PopupFieldBase<string>(effectPatternList, encounterEffect);
                _effectPatternDropdown.Clear();
                _effectPatternDropdown.Add(effectPatternDropdownPopupField);
                effectPatternDropdownPopupField.RegisterValueChangedCallback(evt =>
                {
                    _battleScene.encounterEffect = effectPatternDropdownPopupField.index;
                    Save();
                });
            }
        ...
        private void SetBattleTest() {
            ...
            {
                var selectModalWindow = ImagePicker.Instantiate(PathManager.BATTLE_BACKGROUND_1, true);
                selectModalWindow.ShowWindow(EditorLocalize.LocalizeWindowTitle("Select Image"), data =>
                {
                    ...
                    _SaveSo();
                    SetBattleTestButtonEnabled();
                }, ImageManager.GetBattlebackName(_testScriptable.bgImageName1, 1), true);
            };
            ...
            {
                var selectModalWindow = ImagePicker.Instantiate(PathManager.BATTLE_BACKGROUND_2, true);
                selectModalWindow.ShowWindow(EditorLocalize.LocalizeWindowTitle("Select Image"), data =>
                {
                    var imageName = (string) data;
                    ...
                    _SaveSo();
                    SetBattleTestButtonEnabled();
                }, ImageManager.GetBattlebackName(_testScriptable.bgImageName2, 2), true);
            };
    ...
    public static class EditorSceneController
    {
        ...
        public static void PlayBattleTestScene(string sceneAssertFilePath, BattleTestScriptableObject battleTestSo) {
            ...
            using (new DebugUtil.IndentLog())
            {
                ...
                RpgMakerEditor.IsBattleTestPlay = true;
