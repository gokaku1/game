        ...
        void UpdateDisplay() {
            ...
            switch (_talkWindowType)
            {
                ...
                case TalkWindowType.Select:
                    ...
                    {
                        _windowObj[0].transform.Find("Mask/Highlight/Ruck_1/Box").GetComponent<HorizontalLayoutGroup>(),
                        _windowObj[0].transform.Find("Mask/Highlight/Ruck_2/Box").GetComponent<HorizontalLayoutGroup>(),
                        _windowObj[0].transform.Find("Mask/Highlight/Ruck_3/Box").GetComponent<HorizontalLayoutGroup>(),
                        _windowObj[0].transform.Find("Mask/Highlight/Ruck_4/Box").GetComponent<HorizontalLayoutGroup>(),
                        _windowObj[0].transform.Find("Mask/Highlight/Ruck_5/Box").GetComponent<HorizontalLayoutGroup>(),
                        _windowObj[0].transform.Find("Mask/Highlight/Ruck_6/Box").GetComponent<HorizontalLayoutGroup>()
                    };
                ...
                case TalkWindowType.Item:
                    ...
                    itemShopContent.SetFontBestFit(false);
                    break;
                case TalkWindowType.Event:
                    // 名前設定
