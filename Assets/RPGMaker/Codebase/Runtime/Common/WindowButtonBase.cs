#define USE_SINGLE_CLICK_ACTION //定義するとクリック一回で選択・決定を一気に行う。
...
#else
        private async void OnClickBase() {
#endif
#if (UNITY_EDITOR && !UNITE_WEBGL_TEST) || !UNITY_WEBGL
#else
...
#else
        private async Task OnClickWaitFrame() {
#endif
#if (UNITY_EDITOR && !UNITE_WEBGL_TEST) || !UNITY_WEBGL
            await Task.Delay(1);
#else
