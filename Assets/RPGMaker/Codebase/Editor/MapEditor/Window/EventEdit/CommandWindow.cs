...
namespace RPGMaker.Codebase.Editor.MapEditor.Window.EventEdit
{
    public class CommandWindow : BaseModalWindow
    {
        ...
        /// ボタン名とイベントコードの紐づけ設定
        /// </summary>
        public static Dictionary<string, EventEnum> EventCommandList = new Dictionary<string, EventEnum>
        {
            ...
            {"RespawnPoint",EventEnum.EVENT_CODE_MOVE_RESPAWN_POINT },
            ...
            {"MinimapChange", EventEnum.EVENT_CODE_MAP_CHANGE_MINIMAP},
            ...
            {"CallUnityScene", EventEnum.EVENT_CODE_SCENE_CALL_UNITY_SCENE},
            ...
            {"EffectGlitch", EventEnum.EVENT_CODE_POST_EFFECT_GLITCH},
            {"EffectBlur", EventEnum.EVENT_CODE_POST_EFFECT_BLUR},
            {"EffectBloom", EventEnum.EVENT_CODE_POST_EFFECT_BLOOM},
            {"EffectFill", EventEnum.EVENT_CODE_POST_EFFECT_FILL},
            {"EffectPixelate", EventEnum.EVENT_CODE_POST_EFFECT_PIXELATE},
            {"EffectRemove", EventEnum.EVENT_CODE_POST_EFFECT_REMOVE}
        };
        
        //U350 カスタム移動時に無効にするボタン設定
        public static List<string> CommandButtonDisableList = new List<string>(){
             "MoveRouteSetting",
             "CustomMove",
             "ConditionalBranch",
             "Loop",
             ...
             "battle_enemy_status",
             "battle_enemy_state",
             "battle_enemy_appearance",
             "battle_enemy_transform",
             "battle_enemy_animation",
             "battle_enemy_battleForced",
             "battle_enemy_stop",
        };
        ...
        public virtual void SetBattleOrMapEnabled(EventCodeList.EventType eventType) {
            foreach (var data in EventCommandList)
            {
                Button button = _root.Query<Button>(data.Key);
        ...
        /// </summary>
        public virtual void SetCustomMoveEnabled() 
        {
