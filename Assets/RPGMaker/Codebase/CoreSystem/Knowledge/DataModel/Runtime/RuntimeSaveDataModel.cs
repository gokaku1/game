...
namespace RPGMaker.Codebase.CoreSystem.Knowledge.DataModel.Runtime
{
    ...
    public class RuntimeSaveDataModel
    {
        ...
        public RespawnPointData respawnPointData;
        public RuntimeSaveDataModel() {
            ...
            respawnPointData = new RespawnPointData();
        }
        ...
        public class RespawnPointData {
            public enum EStatus { FULL_RECOVERY, REVIVAL_ONLY };
        
            public string mapID;
            public int x;
            public int y;
            public EStatus eStatus;
            public bool gameOverScreenFlg;
        }
    }
}