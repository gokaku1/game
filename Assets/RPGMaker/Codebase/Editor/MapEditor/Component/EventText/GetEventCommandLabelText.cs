...
using RPGMaker.Codebase.Editor.MapEditor.Component.EventText.PostEffect;
using System;
...
namespace RPGMaker.Codebase.CoreSystem.Service.EventManagement
{
    public class GetEventCommandLabelText
    {
        ...
        private readonly Dictionary<EventEnum, Type> _eventCommandView = new Dictionary<EventEnum, Type>
        {
            ...
            {EventEnum.EVENT_CODE_MOVE_RESPAWN_POINT, typeof(RespawnPointEventText)},
            ...
            {EventEnum.EVENT_CODE_MAP_CHANGE_MINIMAP, typeof(MapChangeMinimap)},
            ...
            {EventEnum.EVENT_CODE_SCENE_CALL_UNITY_SCENE, typeof(SceneCallUnityScene)},
            ...
            // ポストエフェクト
            {EventEnum.EVENT_CODE_POST_EFFECT_GLITCH, typeof(PostEffectGlitch)},
            {EventEnum.EVENT_CODE_POST_EFFECT_BLUR, typeof(PostEffectBlur)},
            {EventEnum.EVENT_CODE_POST_EFFECT_BLOOM, typeof(PostEffectBloom)},
            {EventEnum.EVENT_CODE_POST_EFFECT_FILL, typeof(PostEffectFill)},
            {EventEnum.EVENT_CODE_POST_EFFECT_PIXELATE, typeof(PostEffectPixelate)},
            {EventEnum.EVENT_CODE_POST_EFFECT_REMOVE, typeof(PostEffectRemove)}
        };
