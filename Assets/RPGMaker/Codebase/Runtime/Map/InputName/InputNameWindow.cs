...
#else
        public async Task Init(Action endAction, string actorid, int maxCount) {
#endif
...
#else
                mActorModel = await partyChange.SetActorData(actorid);
#endif
            }
...
#else
            Face.GetComponent<Image>().sprite = await UnityEditorWrapper.AssetDatabaseWrapper.LoadAssetAtPath<Sprite>(FacePath + mActorModel.faceImage + ".png");
#endif
