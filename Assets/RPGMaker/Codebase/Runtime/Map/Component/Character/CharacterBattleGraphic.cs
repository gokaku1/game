...
#else
                var advance = await LoadCharacterSprite(assetManageData.imageSettings[0].path)
                           ?? await LoadObjectSprite(assetManageData.imageSettings[0].path);
                var wait = await LoadCharacterSprite(assetManageData.imageSettings[1].path)
                           ?? await LoadObjectSprite(assetManageData.imageSettings[1].path);
                var chant = await LoadCharacterSprite(assetManageData.imageSettings[2].path)
                            ?? await LoadObjectSprite(assetManageData.imageSettings[2].path);
                var defend = await LoadCharacterSprite(assetManageData.imageSettings[3].path)
                         ?? await LoadObjectSprite(assetManageData.imageSettings[3].path);
                var damage = await LoadCharacterSprite(assetManageData.imageSettings[4].path)
                             ?? await LoadObjectSprite(assetManageData.imageSettings[4].path);
                var evade = await LoadCharacterSprite(assetManageData.imageSettings[5].path)
                             ?? await LoadObjectSprite(assetManageData.imageSettings[5].path);
                var thrust = await LoadCharacterSprite(assetManageData.imageSettings[6].path)
                             ?? await LoadObjectSprite(assetManageData.imageSettings[6].path);
                var swing = await LoadCharacterSprite(assetManageData.imageSettings[7].path)
                         ?? await LoadObjectSprite(assetManageData.imageSettings[7].path);
                var projectile = await LoadCharacterSprite(assetManageData.imageSettings[8].path)
                         ?? await LoadObjectSprite(assetManageData.imageSettings[8].path);
                var skill = await LoadCharacterSprite(assetManageData.imageSettings[9].path)
                         ?? await LoadObjectSprite(assetManageData.imageSettings[9].path);
                var magic = await LoadCharacterSprite(assetManageData.imageSettings[10].path)
                         ?? await LoadObjectSprite(assetManageData.imageSettings[10].path);
                var item = await LoadCharacterSprite(assetManageData.imageSettings[11].path)
                         ?? await LoadObjectSprite(assetManageData.imageSettings[11].path);
                var escape = await LoadCharacterSprite(assetManageData.imageSettings[12].path)
                         ?? await LoadObjectSprite(assetManageData.imageSettings[12].path);
                var win = await LoadCharacterSprite(assetManageData.imageSettings[13].path)
                         ?? await LoadObjectSprite(assetManageData.imageSettings[13].path);
                var nearFallen = await LoadCharacterSprite(assetManageData.imageSettings[14].path)
                         ?? await LoadObjectSprite(assetManageData.imageSettings[14].path);
                var statusAilment = await LoadCharacterSprite(assetManageData.imageSettings[15].path)
                                    ?? await LoadObjectSprite(assetManageData.imageSettings[15].path);
                var sleep = await LoadCharacterSprite(assetManageData.imageSettings[16].path)
                            ?? await LoadObjectSprite(assetManageData.imageSettings[16].path);
                var fallen = await LoadCharacterSprite(assetManageData.imageSettings[17].path)
                            ?? await LoadObjectSprite(assetManageData.imageSettings[17].path);
#endif
