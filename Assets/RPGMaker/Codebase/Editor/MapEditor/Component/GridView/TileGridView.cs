    ...
    public class TileGridView : VisualElement
    {
        ...
        public TileGridView(
            ...
            for (var tileIndex = 0; tileIndex < tileCount;)
            {
                ...
                for (var x = 0; tileIndex < tileCount && x < xCount; x++, tileIndex++)
                {
                    ...
                    image.sprite = _tileEntities[tileIndex].m_DefaultSprite;
                    tileVe.Add(image);
        ...
        private void Select(int selectIndex) {
            if (_selectedIndex >= 0)
            {
                ...
                var imageElement = prevSelectedVe.Q<Image>();
                imageElement.image = null;
                imageElement.sprite = _tileEntities[_selectedIndex].m_DefaultSprite;
            }

            {
                ...
                var imageElement = selectedVe.Q<Image>();
                imageElement.image = null;
                imageElement.sprite = _tileEntities[_selectedIndex + _tileCount].m_DefaultSprite;
