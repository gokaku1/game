...
namespace RPGMaker.Codebase.CoreSystem.Helper
{
    ...
    public static class EventCodeList
    {
        ...
        public static List<EventEnum> Map = new List<EventEnum> { 
                ...
                EventEnum.EVENT_CODE_MOVE_RESPAWN_POINT,
                ...
                //ポストエフェクト,
                EventEnum.EVENT_CODE_POST_EFFECT_GLITCH,
                EventEnum.EVENT_CODE_POST_EFFECT_BLUR,
                EventEnum.EVENT_CODE_POST_EFFECT_BLOOM,
                EventEnum.EVENT_CODE_POST_EFFECT_FILL,
                EventEnum.EVENT_CODE_POST_EFFECT_PIXELATE,
                EventEnum.EVENT_CODE_POST_EFFECT_REMOVE,
                ...
                EventEnum.EVENT_CODE_MAP_CHANGE_MINIMAP,
                ...
                EventEnum.EVENT_CODE_SCENE_CALL_UNITY_SCENE,
        ...
        public static List<EventEnum> Battle = new List<EventEnum> { 
                ...
                EventEnum.EVENT_CODE_BATTLE_STOP,
                //U349 定義追加
                EventEnum.EVENT_CODE_BATTLE_CHANGE_MP,
                EventEnum.EVENT_CODE_BATTLE_CHANGE_TP,
