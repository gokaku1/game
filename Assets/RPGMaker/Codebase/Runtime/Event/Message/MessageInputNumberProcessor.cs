...
#else
            var varData = (await new DatabaseManagementService().LoadFlags()).variables;
#endif
...
#else
                _messageInputNumber = await HudDistributor.Instance.NowHudHandler().OpenInputNumWindow(command.parameters[1]);
#endif
            }
