...
namespace RPGMaker.Codebase.Editor.Inspector.Map.View
{
    ...
    public class PenButtonMenu : VisualElement
    {
        ...
        private void ChangeActiveButton(Image activeButtonImage) {
            ...
            {
                _activeButton.sprite = (Sprite) _spriteObjects.FirstOrDefault(obj => obj.name == MenuEditorView.ImageIconMenu + _activeButton.name);
            }
            //_activeButton.image =
            ...
            image.sprite = (Sprite) _spriteObjects.FirstOrDefault(obj => obj.name == MenuEditorView.ImageIconMenuD + iconName);
            //image.image =
            //    AssetDatabase.LoadAssetAtPath<Texture>(
