...
#else
        public void Init(int index, string label, object data, string menus, ItemMenu itemMenu, System.Action<DebugToolValueItem> callbackAction, System.Func<DebugToolValueItem, Task> selectedCallbackAction, string evId = null) {
#endif
            _index = index;
...
#else
                button.OnSelected += (button) => { _ = selectedCallbackAction(this); };
#endif
            }
