...
#else
        public async Task<List<AssetManageDataModel>> Load() {
#endif
#if UNITY_EDITOR && !UNITE_WEBGL_TEST
...
#else
            List<AssetManageDataModel> assetsData = (await AddressableManager.Load.LoadAssetSync<AssetManagesSO>(SO_PATH + "/assetsData.asset")).dataModels;
#endif
